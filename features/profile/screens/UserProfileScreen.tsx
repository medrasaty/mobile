...
type UserProfileScreenProps = { id: BaseUser["id"] } & ViewProps;

const UserProfileScreen = ({ id, ...props }: UserProfileScreenProps) => {
...
export const ProfileAppbar = ({ userId }: { userId: number | undefined }) => {
